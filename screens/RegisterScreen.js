    ...
    const register = () =>{
       ...
       .then((authUser) => {
           authUser.user.updateProfile({
            displayName: name,
            photoURL:imageUrl || "https://www.pngall.com/wp-content/uploads/5/User-Profile-PNG-Image.png"
           })
       })
    ...
    return (
        ...
        <StatusBar style="light"/>
            ...
            <View style={styles.inputContainer}>
                ...
                <Input placeholder="Profile Image URL (optional)" type="text" value={imageUrl} onChangeText={text => setImageUrl(text)} onSubmitEditing={register}/>
            </View>
